...
def encode_preview(kind,data,width=640):
...
class PreviewCache:
    ...
    def get(self,key,kind,data,width):
        ...
        with self.lock:
            ...
            value=encode_preview(kind,data,width);self.encodes+=1;self.items[key]=value;self.bytes+=len(value[0])
