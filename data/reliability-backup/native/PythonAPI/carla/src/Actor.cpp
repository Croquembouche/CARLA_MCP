...
void export_actor() {
  ...
  class_<cc::TrafficLight, bases<cc::TrafficSign>, boost::noncopyable, std::shared_ptr<cc::TrafficLight>>(
      ...
      .def("freeze_group", &cc::TrafficLight::FreezeGroup, (arg("freeze")))
    .def("set_movement_states", &cc::TrafficLight::SetMovementStates, (arg("states")))
    .def("get_movement_states", &cc::TrafficLight::GetMovementStates)
